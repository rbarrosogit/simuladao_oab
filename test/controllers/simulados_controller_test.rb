...
class SimuladosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create simulado" do
    assert_difference('Simulado.count') do
      post simulados_url, params: { simulado: { description: @simulado.description, question: @simulado.question, subject: @simulado.subject, title: @simulado.title } }
    end
  ...
  test "should update simulado" do
    patch simulado_url(@simulado), params: { simulado: { description: @simulado.description, question: @simulado.question, subject: @simulado.subject, title: @simulado.title } }
